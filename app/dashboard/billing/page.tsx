export default function BillingPage() {
  return (
    <div className="max-w-4xl">
      ...
      <div className="mt-8 bg-white border border-gray-100 rounded-2xl p-12 text-center">
        <p className="text-gray-300 text-4xl mb-4">💳</p>
        <p className="text-gray-500 font-medium">Billing management coming soon</p>
        <p className="text-gray-400 text-sm mt-1">Stripe integration will be added here.</p>
      </div>
    </div>
  )
}